...
}).AddInMemoryIdentityResources(StaticDefinitions.IdentityResources)
.AddInMemoryApiScopes(StaticDefinitions.ApiScopes)
.AddInMemoryClients(StaticDefinitions.Clients)
.AddAspNetIdentity<ApplicationUser>();
builder.Services.AddScoped<IDbInitializer, DbInitializer>();
builder.Services.AddScoped<IProfileService, ProfileService>(); // Duende
